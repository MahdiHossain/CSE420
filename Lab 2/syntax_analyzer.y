...
%token IF ELSE FOR DO INT FLOAT VOID ID SWITCH DEFAULT GOTO WHILE BREAK CHAR DOUBLE RETURN CASE CONTINUE PRINTF
	CONST_INT CONST_FLOAT INCOP PRINTLN DECOP MULOP ADDOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD 
...
parameter_list : parameter_list COMMA type_specifier ID
	{
		...
		outlog<<$1->getname()<<" "<<",\n"<<$3->getname()<<$4->getname()<<endl<<endl;

		$$ = new symbol_info($1->getname()+" "+",\n"+$3->getname()+$4->getname(),"parameter_list");
	}
...
statements: statement
	...
	| statements statement
	{
		...
		$$ = new symbol_info($1->getname()+" "+$1->getname(),"statements");
...
statement : var_declaration
	...
	| IF LPAREN expression RPAREN statement ELSE statement
	{
		...
		outlog<<"if("<<$3->getname()<<")\n"<<$5->getname()<<"else"<<$7->getname()<<endl<<endl;
